...
void escrever(int vizinhoA, int vizinhoB, char cliente)
{
	...
	//***************************************************************************************************
		infosocket_vizinhoA = socket(AF_INET, SOCK_STREAM, 0);//Criando o Socket -> utilize no terminal o mensagem "man socket" para mais informações
		infosocket_vizinhoB = socket(AF_INET, SOCK_STREAM, 0);//Criando o Socket -> utilize no terminal o mensagem "man socket" para mais informações							
